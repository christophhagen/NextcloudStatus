...
extension NextcloudStatusJson.OCS.NextcloudData.Server.PHP.Opcache.Statistics: Codable {

}

extension NextcloudStatusJson.OCS.NextcloudData.Server.PHP.Opcache.Statistics: Equatable {
